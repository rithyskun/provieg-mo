/**
* @author daemach
* lignes modifiées pour supprimer le menu et mettre la pagination en haut : 75,78,283,391,400-406
*/
    ...
    prototype: {
        ...
        parseTable: function(){
            ...
            if (this.settings.paging && this.tbody.rows.length){
                ...
                this.pagingRow = jQuery(this.headerRows[1]).clone().removeAttr("id").css("background","white").empty().prependTo(head); // paging row
        ...
        createMenu: function(id, base, container, direction, trigger, inEvent, outEvent,menuClass){
            ...
            menu = $('<div id="'+id+'" class="tableFilter_menu '+menuClass+'"><ul id="'+id+'_root"></ul></div>').appendTo(base);
