...
class Sitemap {
	 ...
	 * @param boolean $include_domain The default is include the domain otherwise do not include 
	 * @return Sitemap
	 */
	public function addItem($loc, $priority = self::DEFAULT_PRIORITY, $changefreq = NULL, $lastmod = NULL, $include_domain = TRUE) {
		...
		$this->getWriter()->writeElement('loc', ($include_domain?$this->getDomain():'') . $loc);
