...
+function ($) {
  ...
  BFHLanguages.prototype = {
    ...
    addBootstrapLanguages: function() {
      ...
      this.options.mobile = this.options.mobile === true ? (jQuery.browser.mobile || this.options.force) : false;
      for (language in languages) {
        if (languages.hasOwnProperty(language)) {
          if (languages[language].hasOwnProperty('name')) {
        	if(this.options.mobile === true) {
                if (this.options.flags === true) {
                  $options.append('<li><a tabindex="-1" href="#" data-option="' + language + '_' + languages[language].country + '"><i class="glyphicon bfh-flag-' + languages[language].country + '"></i></a></li>');
                  $('.bfh-selectbox-toggle').css({'padding':'7px 8px 4px 12px'});
                  $('.bfh-selectbox-options').css({'min-width':'0'});
                  $('.bfh-selectbox-options ul li > a').css({'padding':'4px 8px 4px 12px'});
                } else {
                  $options.append('<li><a tabindex="-1" href="#" data-option="' + language + '_' + languages[language].country + '">' + languages[language].name.toProperCase() + '</a></li>');
                }
        	}else {
        		if (this.options.flags === true) {
  ...
  BFHSelectBox.prototype = {
    ...
    initSelectBox: function () {
      ...
      this.$element.html(
		...
		(this.options.mobile === true ? '' : ('<span class="' + this.options.icon + ' selectbox-caret"></span>')) +
		'</a>' +
